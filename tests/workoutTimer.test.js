    ...
    describe('Module Initialization', () => {
        ...
        it('should expose all required public methods', () => {
            ...
            requiredMethods.forEach(method => {
                assert.isFunction(WorkoutTimer[method], `Method ${method} should be a function`);
            });
        });
    ...
    describe('Timer Events', () => {
        ...
        it('should emit STARTED event when timer starts', (done) => {
            const handler = (event) => {
                ...
                document.removeEventListener(WorkoutTimer.TIMER_EVENTS.STARTED, handler);
                WorkoutTimer.stopTimer();
                done();
            };
        ...
        it('should emit STOPPED event when timer stops', (done) => {
            const handler = (event) => {
                assert.isObject(event.detail);
                document.removeEventListener(WorkoutTimer.TIMER_EVENTS.STOPPED, handler);
                done();
            };
        ...
        it('should emit RESUMED event when timer resumes', (done) => {
            const handler = (event) => {
                assert.isObject(event.detail);
                document.removeEventListener(WorkoutTimer.TIMER_EVENTS.RESUMED, handler);
                WorkoutTimer.stopTimer();
                done();
            };
