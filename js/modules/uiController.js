...
const UIController = (() => {
    ...
    const cacheElements = () => {
        ...
        elements.operationModeInputs = document.querySelectorAll('input[name="operationMode"]');
    ...
    const updateModeIndicator = () => {
        if (elements.modeIndicator) {
            const modeText = currentOperationMode === 'regenerate' ? 'Regenerate Mode' : 'Replace Mode';
     ...
     * @public
     */
    const renderWorkoutList = (exercises) => {
